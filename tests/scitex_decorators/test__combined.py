...
@mock.patch("scitex_decorators._combined.torch_fn")
@mock.patch("scitex_decorators._combined.batch_fn")
...
@mock.patch("scitex_decorators._combined.numpy_fn")
@mock.patch("scitex_decorators._combined.batch_fn")
...
@mock.patch("scitex_decorators._combined.pandas_fn")
@mock.patch("scitex_decorators._combined.batch_fn")
...
@mock.patch("scitex_decorators._combined.torch_fn", side_effect=lambda x: x)
@mock.patch("scitex_decorators._combined.batch_fn", side_effect=lambda x: x)
...
@mock.patch("scitex_decorators._combined.numpy_fn", side_effect=lambda x: x)
@mock.patch("scitex_decorators._combined.batch_fn", side_effect=lambda x: x)
...
@mock.patch("scitex_decorators._combined.pandas_fn", side_effect=lambda x: x)
@mock.patch("scitex_decorators._combined.batch_fn", side_effect=lambda x: x)
...
def test_combined_decorator_dependencies():
    ...
    from scitex_decorators import batch_fn, numpy_fn, pandas_fn, torch_fn
